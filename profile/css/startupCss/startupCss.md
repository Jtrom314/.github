...
- Properly styled CSS
  - 70% All elements within the Header, footer, and main content body are styled beyond the default styling on every HTML page
  ...
  - 10% All student generated CSS is located within CSS files
